      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="order-2 lg:order-1 animate-in fade-in slide-in-from-left-8 duration-1000">
            ...
            <p className="text-xl md:text-2xl text-slate-600 font-light mb-10 max-w-lg leading-relaxed">
              <span 
                contentEditable={isAdmin}
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              <a href="#atuacao" className="group relative px-10 py-5 bg-slate-900 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-[1.02] active:scale-[0.98] shadow-2xl shadow-slate-900/20 text-center">
              ...
              <a href="#contato" className="px-10 py-5 bg-white text-slate-900 border border-slate-200 font-bold rounded-2xl hover:bg-slate-50 transition-all text-center shadow-sm">
                Falar com Jailton
              </a>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end animate-in fade-in zoom-in duration-1000">
            <div className={`relative w-full max-w-md aspect-[4/5] group ${isAdmin ? 'cursor-pointer' : ''}`} onClick={triggerUpload}>
              <div className="absolute -top-6 -right-6 w-full h-full bg-green-700/5 rounded-[2.5rem] -rotate-3 transition-transform group-hover:rotate-0 duration-700" aria-hidden="true"></div>
              
              <div className="relative w-full h-full overflow-hidden rounded-[2.5rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.2)] bg-slate-200 border-8 border-white">
